...
sed -i -e "s/%define release_extra.*/%define release_extra ${PRODUCT_LABEL}${PRODUCT_VERSION}/g" cray-rxe-driver.spec
sed -i -e "s/Release:.*/Release: ${PRODUCT_LABEL}${PRODUCT_VERSION}_%(echo \\\${BUILD_METADATA:-1})/g" cray-rxe-driver.spec
